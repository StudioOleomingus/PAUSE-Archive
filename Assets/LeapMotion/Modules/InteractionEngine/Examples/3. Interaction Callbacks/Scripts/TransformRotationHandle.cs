...
namespace Leap.Unity.Examples {
  ...
  public class TransformRotationHandle : TransformHandle {
    ...
    private void onGraspedMovement(Vector3 presolvePos, Quaternion presolveRot, Vector3 solvedPos, Quaternion solvedRot, List<Leap.Unity.Interaction.InteractionController> controllers) {
      /* 
